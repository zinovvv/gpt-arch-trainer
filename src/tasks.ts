...
export const tasks: Task[] = [
  {
    id: 'blank', // Уникальный ID
    title: 'Пустой проект',
    description: 'Начните проектирование с чистого листа, без готового сценария.',
    // Этапы для LLM, чтобы она знала, как себя вести в "свободном" режиме
    stages: [
      '1. Приветствие: Поприветствуй пользователя и спроси, какую систему он хочет спроектировать.',
      '2. Свободное проектирование: Веди диалог, помогая пользователю определять компоненты, связи и технологии. Активно предлагай паттерны и спрашивай про нефункциональные требования.',
      '3. Финальная рецензия: Когда пользователь напишет "завершить проектирование", дай краткий обзор получившейся архитектуры.'
    ],
  },
  {
    id: 'crm',
